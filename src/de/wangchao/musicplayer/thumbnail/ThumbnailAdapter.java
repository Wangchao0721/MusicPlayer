...
public class ThumbnailAdapter extends AdapterWrapper {
    ...
    private MySimpleWebImageCache<ThumbnailBus, ThumbnailMessage> cache = null;
    ...
    public ThumbnailAdapter(Activity host, ListAdapter wrapped,
            MySimpleWebImageCache<ThumbnailBus, ThumbnailMessage> cache, int[] imageIds) {
    ...
    public void processView(View row) {
        ...
        for (int imageId : imageIds) {
            ...
            if (image != null && image.getTag() != null) {
                final String url = image.getTag().toString().trim();
