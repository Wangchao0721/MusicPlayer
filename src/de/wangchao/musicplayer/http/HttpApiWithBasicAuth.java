...
public class HttpApiWithBasicAuth extends AbstractHttpApi {
    ...
    // @Override
    // public FeiyoungType doHttpRequest(HttpRequestBase httpRequest,
    // Class<? extends FeiyoungType> typeClass) throws
    // FeiyoungCredentialsException,
    // FeiyoungException, IOException {
    //
    // return executeHttpRequest(httpRequest, typeClass);
    // }
}
